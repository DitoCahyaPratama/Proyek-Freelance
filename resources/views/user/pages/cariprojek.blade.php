                ...
                <div class="input-group input-group-lg">
                  ...
                  <div class="input-group-append">
                    <span class="input-group-text border-0 py-0 pl-1 pr-3">
                      ...
                      <!-- Button -->
                      <button name="search" type="submit" class="btn btn-sm btn-primary">
                        Cari
                      </button>
        ...
        <div class="container">
          <div class="row">
            ...
            if (isset($_POST['search'])) {
              include('../backend/project/searchByName.php');
            }
                ...
                <div class="col-12 col-md-6 col-lg-4 d-flex">
                  ...
                  <div class="card mb-6 shadow-light-lg lift lift-lg">
                    ...
                    <a class="card-body" href="">
                      ...
                      ?>
                        <p class="mt-4 text-danger">Untuk claim anda anda harus login sebagai freelance</p>
                      <?php
                      }
                      ?>
                      <form action="/detailprojek" method="POST">
