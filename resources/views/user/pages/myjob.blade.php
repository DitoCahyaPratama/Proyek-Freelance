...
<section class="py-6">
    <div class="container">
        <button class="btn btn-primary btn-sm mt-5" data-toggle="modal" data-target="#modalAdd">Tambah Pekerjaan</button>
        <?php
                        ...
                        <div class="card mb-6 shadow-light-lg lift lift-lg">
                            ...
                            <a class="card-meta mt-auto" href="#!">
                                ...
                                <div class="avatar avatar-sm mr-2">
                                    <img src="../backend/public/img/<?= $datas['avatarUser'] ?>" alt="..." class="avatar-img rounded-circle">
                                </div>
