...
<!-- BREADCRUMB
    ...
    <section class="py-6">
        <div class="container">
            <button class="btn btn-primary btn-sm mt-5" data-toggle="modal" data-target="#modalAdd">Tambah Projek</button>
            <?php
                        ...
                        <div class="col-12 col-md-6 col-lg-4 d-flex">
                            ...
                            <div class="card mb-6 shadow-light-lg lift lift-lg">
                                ...
                                <a class="card-body" href="#!">
                                    ...
                                    if ($datas['status'] == 0) {
                                    ?>
                                        <span class="badge badge-warning">Belum diclaim</span>
                                    <?php
                                    } else if ($datas['status'] == 1) {
                                    ?>
                                        <span class="badge badge-success">Diclaim</span>
                                    <?php
                                    } else {
                                    ?>
                                    ...
                                    ?>
                                    <form action="/detailMyprojek" method="POST">
                                        <input type="hidden" name="id" value="<?= $datas['id'] ?>">
                                        <button name="edit" class="btn btn-info btn-xs m-1"><i class="fe fe-info"></i> Detail</button>
                                    </form>
                                </a>
